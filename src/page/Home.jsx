...
const Home = () => {
    ...
    return (
        <div>
            <TopMovie data={topMovie} onImageClick={(id) => navigate(`/detail/${id}`)} />
            <PopulerMovie data={popularMovie} onImageClick={(id) => navigate(`/detail/${id}`)} />
            <UpcomingMovie data={upcomingMovie} onImageClick={(id) => navigate(`/detail/${id}`)} />
        </div>
    );
};
